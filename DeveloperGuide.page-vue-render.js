...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command entered by the user is parsed and the different fields are tokenized.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand#execute(Model model)")]),_v(" is invoked which checks for validity of the entered parameter values.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("If successful, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" object is created to show a success message in the feedback box of the ui.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" allows users to modify the details of an existing person in the address book.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"command-structure"}},[_v("Command Structure"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#command-structure","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"execution-steps"}},[_v("Execution Steps"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#execution-steps","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Parsing:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The input arguments are parsed to extract the index and the new values for the person's details.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"2"}},[_c('li',[_v("Validation:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The validity of the index and the absence of duplicate prefixes are verified.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"3"}},[_c('li',[_v("Creation of Edit Descriptor:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("An "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditPersonDescriptor")]),_v(" object is created to store the edited details.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"4"}},[_c('li',[_v("Field Editing:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Each provided field is set in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditPersonDescriptor")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"5"}},[_c('li',[_v("Execution:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" is executed, modifying the specified person's details in the address book.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"6"}},[_c('li',[_v("Feedback:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("A success message is generated to confirm the editing operation.")])])}
},function anonymous(
) {
with(this){return _c('h2',{attrs:{"id":"design-considerations-2"}},[_v("Design Considerations"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#design-considerations-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Name: John Doe")]),_v(" "),_c('li',[_v("Phone: 12345678")]),_v(" "),_c('li',[_v("Email: "),_c('a',{attrs:{"href":"mailto:johndoe@example.com"}},[_v("johndoe@example.com")])]),_v(" "),_c('li',[_v("Address: Block 123, Avenue Street, #08-123")]),_v(" "),_c('li',[_v("Job Description: Software Engineer")]),_v(" "),_c('li',[_v("Interview Date: 2024-04-15")]),_v(" "),_c('li',[_v("Intern Duration: 3 months")]),_v(" "),_c('li',[_v("Salary: $3000")]),_v(" "),_c('li',[_v("Tags: #java, #software")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" will update John Doe's phone number to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("87654321")]),_v(" and address to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Block 456, New Avenue, #05-678")]),_v(".\nUpon successful execution, a message will be displayed confirming the changes made to John Doe's details.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("CS students")]),_v(" "),_c('li',[_v("has a need to keep track of contacts of companies and interview dates during thier internship hunt")]),_v(" "),_c('li',[_v("prefer a one-stop, centralised dashboard to manage all contact details of companies")]),_v(" "),_c('li',[_v("is reasonably comfortable in using a more CLI based app")]),_v(" "),_c('li',[_v("wants to be better organized")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Ultimate companion for Computer Science (CS) students embarking on their internship journey !")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Handling of invalid date to be with accordance of Gregorian Calendar")])]),_v(" "),_c('li')])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Wed, 10 Apr 2024, 13:06:50 GMT+8]")])])])}
}];
